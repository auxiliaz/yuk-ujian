...
import 'package:yuk_ujian/buat_ujian.dart';
...
class _TeacherHomePage extends State<TeacherHomePage> {
  ...
  final List jobsForYou = [
    ['Kelas 7C', 'Matematika', 'assets/kelas.png', '30 Siswa'],
    ['Kelas 9A', 'Matematika Tingkat', 'assets/kelas.png', '28 Siswa'],
    ['Kelas 8A', 'Matematika', 'assets/kelas.png', '32 Siswa'],
    ['Kelas 9B', 'Matematika Dasar', 'assets/kelas.png', '29 Siswa'],
    ['Kelas 9A', 'Matematika', 'assets/kelas.png', '25 Siswa'],
  ];
  ...
  final List<Map<String, String>> daftarCard = [
    {
      ...
      'subtitle': 'Dibuat: 1 Juni 2025',
    },
    {
      'judul': 'Ujian IPA',
      'gambar': 'assets/math.png',
      'subtitle': 'Dibuat: 3 Juni 2025',
    },
    {
      'judul': 'Ujian Matematika',
      'gambar': 'assets/english.png',
  ...
  List<Map<String, dynamic>> classes = [
    ...
    {
      'id': '4',
      'title': 'Matematika Dasar Kelas 9B',
      'studentCount': 29,
      'color': Colors.orange,
      'students': [
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          KotakMenu(
                            gambar: 'assets/create.svg',
                            label: 'Buat Ujian',
                            isSvg: true,
                            onTap: () {
                              Navigator.pushReplacement(
                                context, 
                                MaterialPageRoute(builder: (context) => BuatUjianPage()),
                                );
                            },
                          ),
                          KotakMenu(
                            gambar: 'assets/library.svg',
                            label: 'Perpustakaan',
                            isSvg: true,
                            onTap: () {
                              setState(() {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return JobCard(
                            namaKelas: jobsForYou[index][0],
                            judulKelas: jobsForYou[index][1],
                            logoImagePath: jobsForYou[index][2],
                            jumlahSiswa: jobsForYou[index][3],
                            cardIndex: index,
                          );
                        },
                      ),
...
class KotakMenu extends StatelessWidget {
  final String gambar;
  final String label;
