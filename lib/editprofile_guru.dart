...
class EditProfileTeacherPage extends StatefulWidget {
  @override
  _EditProfileTeacherPageState createState() => _EditProfileTeacherPageState();
}

class _EditProfileTeacherPageState extends State<EditProfileTeacherPage> {
  final _formKey = GlobalKey<FormState>();
  final _nameController = TextEditingController(text: 'Madelyn Cline');
  final _emailController = TextEditingController(text: 'madelyn.mae@gmail.com');
